...
trashBinPath1.setAttribute("transform", "scale(0.05)");
...
trashBinPath2.setAttribute("transform", "scale(0.05)");
...
trashBinPath3.setAttribute("transform", "scale(0.05)");
...
trashBinPath4.setAttribute("transform", "scale(0.05)");

let trashBinIcon = document.createElementNS("http://www.w3.org/2000/svg", "svg"); 
trashBinIcon.setAttribute("height", 24);
trashBinIcon.setAttribute("width", 24);
trashBinIcon.appendChild(trashBinPath1);
trashBinIcon.appendChild(trashBinPath2);
trashBinIcon.appendChild(trashBinPath3);
trashBinIcon.appendChild(trashBinPath4);

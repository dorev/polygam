...
for(let originNode = 0; originNode < 12; ++originNode) {
  ...
  neighborNodes.forEach(neighborNode => {
    ...
    // Find common chords    
    let chordsOfOrigin = graph.nodes[originNode].edges.filter(edge => edge.target >= 12).map(edge => edge.target); 
    let chordsOfNeighbor = graph.nodes[neighborNode].edges.filter(edge => edge.target >= 12).map(edge => edge.target);
    let commonChords = [];
...
graph.nodeClick = node => {  
  ...
  let relevantNodesTarget = graph.links.filter(d => d.source.id === node.id).map(link => link.target.id);
  let relevantNodesSource = graph.links.filter(d => d.target.id === node.id).map(link => link.source.id);
...
//tonnetze = JSON.parse("[{\"edges\":{\"+x\":7,\"+y\":4,\"+z\":9,\"-x\":5,\"-y\":8,\"-z\":3},\"id\":0,\"type\":\"note\",\"chords\":[12,13,14,15,16,17]},{\"edges\":{\"+x\":8,\"+y\":5,\"+z\":10,\"-x\":6,\"-y\":9,\"-z\":4},\"id\":1,\"type\":\"note\",\"chords\":[18,19,20,21,22,23]},{\"edges\":{\"+x\":9,\"+y\":6,\"+z\":11,\"-x\":7,\"-y\":10,\"-z\":5},\"id\":2,\"type\":\"note\",\"chords\":[24,25,26,27,28,29]},{\"edges\":{\"+x\":10,\"+y\":7,\"+z\":0,\"-x\":8,\"-y\":11,\"-z\":6},\"id\":3,\"type\":\"note\",\"chords\":[13,17,30,31,32,33]},{\"edges\":{\"+x\":11,\"+y\":8,\"+z\":1,\"-x\":9,\"-y\":0,\"-z\":7},\"id\":4,\"type\":\"note\",\"chords\":[12,14,19,23,34,35]},{\"edges\":{\"+x\":0,\"+y\":9,\"+z\":2,\"-x\":10,\"-y\":1,\"-z\":8},\"id\":5,\"type\":\"note\",\"chords\":[15,16,18,20,25,29]},{\"edges\":{\"+x\":1,\"+y\":10,\"+z\":3,\"-x\":11,\"-y\":2,\"-z\":9},\"id\":6,\"type\":\"note\",\"chords\":[21,22,24,26,31,33]},{\"edges\":{\"+x\":2,\"+y\":11,\"+z\":4,\"-x\":0,\"-y\":3,\"-z\":10},\"id\":7,\"type\":\"note\",\"chords\":[12,13,27,28,30,35]},{\"edges\":{\"+x\":3,\"+y\":0,\"+z\":5,\"-x\":1,\"-y\":4,\"-z\":11},\"id\":8,\"type\":\"note\",\"chords\":[16,17,18,19,32,34]},{\"edges\":{\"+x\":4,\"+y\":1,\"+z\":6,\"-x\":2,\"-y\":5,\"-z\":0},\"id\":9,\"type\":\"note\",\"chords\":[14,15,22,23,24,25]},{\"edges\":{\"+x\":5,\"+y\":2,\"+z\":7,\"-x\":3,\"-y\":6,\"-z\":1},\"id\":10,\"type\":\"note\",\"chords\":[20,21,28,29,30,31]},{\"edges\":{\"+x\":6,\"+y\":3,\"+z\":8,\"-x\":4,\"-y\":7,\"-z\":2},\"id\":11,\"type\":\"note\",\"chords\":[26,27,32,33,34,35]},{\"edges\":{\"-x\":13,\"-y\":14,\"+z\":35},\"id\":12,\"type\":\"chord\",\"voicing\":\"major\",\"root\":0,\"notes\":[0,7,4],\"fifth\":7,\"third\":4},{\"edges\":{\"+x\":12,\"-z\":17,\"+y\":30},\"id\":13,\"type\":\"chord\",\"voicing\":\"minor\",\"root\":0,\"notes\":[0,7,3],\"fifth\":7,\"third\":3},{\"edges\":{\"+y\":12,\"-z\":15,\"+x\":23},\"id\":14,\"type\":\"chord\",\"voicing\":\"minor\",\"third\":0,\"notes\":[0,4,9],\"fifth\":4,\"root\":9},{\"edges\":{\"+z\":14,\"-x\":16,\"-y\":25},\"id\":15,\"type\":\"chord\",\"voicing\":\"major\",\"fifth\":0,\"notes\":[0,9,5],\"third\":9,\"root\":5},{\"edges\":{\"+x\":15,\"+y\":17,\"-z\":18},\"id\":16,\"type\":\"chord\",\"voicing\":\"minor\",\"fifth\":0,\"notes\":[0,5,8],\"root\":5,\"third\":8},{\"edges\":{\"-y\":16,\"+z\":13,\"-x\":32},\"id\":17,\"type\":\"chord\",\"voicing\":\"major\",\"third\":0,\"notes\":[0,8,3],\"root\":8,\"fifth\":3},{\"edges\":{\"-x\":19,\"-y\":20,\"+z\":16},\"id\":18,\"type\":\"chord\",\"voicing\":\"major\",\"root\":1,\"notes\":[1,8,5],\"fifth\":8,\"third\":5},{\"edges\":{\"+x\":18,\"-z\":23,\"+y\":34},\"id\":19,\"type\":\"chord\",\"voicing\":\"minor\",\"root\":1,\"notes\":[1,8,4],\"fifth\":8,\"third\":4},{\"edges\":{\"+y\":18,\"-z\":21,\"+x\":29},\"id\":20,\"type\":\"chord\",\"voicing\":\"minor\",\"third\":1,\"notes\":[1,5,10],\"fifth\":5,\"root\":10},{\"edges\":{\"+z\":20,\"-x\":22,\"-y\":31},\"id\":21,\"type\":\"chord\",\"voicing\":\"major\",\"fifth\":1,\"notes\":[1,10,6],\"third\":10,\"root\":6},{\"edges\":{\"+x\":21,\"+y\":23,\"-z\":24},\"id\":22,\"type\":\"chord\",\"voicing\":\"minor\",\"fifth\":1,\"notes\":[1,6,9],\"root\":6,\"third\":9},{\"edges\":{\"-y\":22,\"+z\":19,\"-x\":14},\"id\":23,\"type\":\"chord\",\"voicing\":\"major\",\"third\":1,\"notes\":[1,9,4],\"root\":9,\"fifth\":4},{\"edges\":{\"-x\":25,\"-y\":26,\"+z\":22},\"id\":24,\"type\":\"chord\",\"voicing\":\"major\",\"root\":2,\"notes\":[2,9,6],\"fifth\":9,\"third\":6},{\"edges\":{\"+x\":24,\"-z\":29,\"+y\":15},\"id\":25,\"type\":\"chord\",\"voicing\":\"minor\",\"root\":2,\"notes\":[2,9,5],\"fifth\":9,\"third\":5},{\"edges\":{\"+y\":24,\"-z\":27,\"+x\":33},\"id\":26,\"type\":\"chord\",\"voicing\":\"minor\",\"third\":2,\"notes\":[2,6,11],\"fifth\":6,\"root\":11},{\"edges\":{\"+z\":26,\"-x\":28,\"-y\":35},\"id\":27,\"type\":\"chord\",\"voicing\":\"major\",\"fifth\":2,\"notes\":[2,11,7],\"third\":11,\"root\":7},{\"edges\":{\"+x\":27,\"+y\":29,\"-z\":30},\"id\":28,\"type\":\"chord\",\"voicing\":\"minor\",\"fifth\":2,\"notes\":[2,7,10],\"root\":7,\"third\":10},{\"edges\":{\"-y\":28,\"+z\":25,\"-x\":20},\"id\":29,\"type\":\"chord\",\"voicing\":\"major\",\"third\":2,\"notes\":[2,10,5],\"root\":10,\"fifth\":5},{\"edges\":{\"-x\":31,\"-y\":13,\"+z\":28},\"id\":30,\"type\":\"chord\",\"voicing\":\"major\",\"root\":3,\"notes\":[3,10,7],\"fifth\":10,\"third\":7},{\"edges\":{\"+x\":30,\"-z\":33,\"+y\":21},\"id\":31,\"type\":\"chord\",\"voicing\":\"minor\",\"root\":3,\"notes\":[3,10,6],\"fifth\":10,\"third\":6},{\"edges\":{\"+x\":17,\"+y\":33,\"-z\":34},\"id\":32,\"type\":\"chord\",\"voicing\":\"minor\",\"fifth\":3,\"notes\":[3,8,11],\"root\":8,\"third\":11},{\"edges\":{\"-y\":32,\"+z\":31,\"-x\":26},\"id\":33,\"type\":\"chord\",\"voicing\":\"major\",\"third\":3,\"notes\":[3,11,6],\"root\":11,\"fifth\":6},{\"edges\":{\"-x\":35,\"-y\":19,\"+z\":32},\"id\":34,\"type\":\"chord\",\"voicing\":\"major\",\"root\":4,\"notes\":[4,11,8],\"fifth\":11,\"third\":8},{\"edges\":{\"+x\":34,\"-z\":12,\"+y\":27},\"id\":35,\"type\":\"chord\",\"voicing\":\"minor\",\"root\":4,\"notes\":[4,11,7],\"fifth\":11,\"third\":7}]");
